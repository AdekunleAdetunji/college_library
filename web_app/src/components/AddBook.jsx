    ...
    return (
        <div className={`${showModal ? '' : 'hidden'} w-full h-full fixed top-0 left-0 bg-black bg-opacity-80 flex items-center justify-center z-10 overflow-auto`}>
            <div className='absolute w-full top-0 left-0 py-6 flex items-center justify-center overflow-auto'>
                <div className="flex flex-col w-full md:max-w-[80%] justify-center  z-10 items-center bg-white rounded-lg">
                    <form onSubmit={handleSubmit} className=" md:w-full p-2 md:p-6 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">

                        <h1 className="text-gray-800 font-bold text-2xl mb-8">Add a book</h1>
                        <div className='w-full flex flex-col md:flex-row md:mb-4 md:items-center md:justify-between'>
                            ...
                            <div className='md:h-[412px] md:w-[1px] bg-slate-300'></div>
                            <div className='flex flex-col  gap-4'>
