...
const Register = ({
  ...
  const formSchema = z.object({
    ...
    confirmPassword: z.string().min(6, { message: "Minimum of 6 characters" }),
  }).refine(data => data.password === data.confirmPassword, {message: "Passwords must be the same", path: ["confirmPassword"]});
